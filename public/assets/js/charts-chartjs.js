  ...
  var b = document.getElementById("barChart"),
        ...
        new Chart(b, {
          ...
          options: {
            ...
            scales: {
              x: {
                min: 0,
                grid: { color: c, borderColor: c },
                ticks: { color: s },
              },
              y: {
                grid: { borderColor: c, display: !1, drawBorder: !1 },
                ticks: { color: s },
              },
            },
          },
    ...
    b =
      (b &&
        ...
        C.addColorStop(1, "rgba(151, 135, 255, 0.8)"),
        (y = b
          .getContext("2d")
          .createLinearGradient(0, 0, 0, 150)).addColorStop(
          0,
        ...
        y.addColorStop(1, "rgba(255, 135, 135, 0.8)"),
        new Chart(b, {
          type: "radar",
          data: {
          ...
          options: {
            ...
            plugins: {
              legend: {
                rtl: isRtl,
                position: "top",
                labels: { padding: 25, color: p, font: { family: "Inter" } },
              },
              tooltip: {
                rtl: isRtl,
                backgroundColor: n,
      ...
      (C &&
        new Chart(C, {
          ...
          options: {
            ...
            scales: {
              x: {
                grid: { color: "transparent", borderColor: c },
                ticks: { color: s },
              },
              y: {
                min: 0,
        ...
        new Chart(b, {
          ...
          data: {
            ...
            datasets: [
              {
                data: [10, 10, 80],
                backgroundColor: [t, e, config.colors.primary],
                borderWidth: 0,
      ...
      options: {
        ...
        scales: {
          x: {
            min: 0,
            max: 140,
            grid: { color: c, drawTicks: !1, drawBorder: !1, borderColor: c },
            ticks: { stepSize: 10, color: s },
          },
          y: {
            min: 0,
