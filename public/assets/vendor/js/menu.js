            ...
            a = (function () {
                function e(t) {
                    ...
                    if (
                        ...
                        (this._showDropdownOnHover = Boolean(
                            n.showDropdownOnHover
                        )),
                        ...
                        r
                            ? ((this._scrollbar = new r(
                                  t.querySelector(".menu-inner"),
                                  {
                                      suppressScrollX: !0,
                    ...
                    (n = [
                        {
                            ...
                            value: function () {
                                ...
                                (this._evntElClick = function (n) {
                                    ...
                                    var o = n.target.classList.contains(
                                        "menu-toggle"
                                    )
                                        ? n.target
                                        : e._findParent(
                                    ...
                                    this._horizontal &&
                                        ((this._evntPrevBtnClick = function (
                                            e
                                        ) {
                                            e.preventDefault(),
                                        ...
                                        this._showDropdownOnHover &&
                                            ((this._evntElMouseOver = function (
                                                e
                                            ) {
                                                if (
                                                    e.target !==
                        ...
                        },
                        {
                            ...
                            value: function (e) {
                                var t,
                                    ...
                                    i = this._innerWidth;
                                "next" === e
                                    ? i + (t = this._getSlideNextPos()) < n &&
                                      (t = n - i)
                                    : (t = this._getSlidePrevPos()) > 0 &&
                                      (t = 0),
                        ...
                        },
                        {
                            ...
                            value: function (t, n) {
                                ...
                                for (
                                    var r = 0,
                                        s = (i = i.slice(0, i.indexOf(o)))
                                            .length;
                                    r < s;
                                    r++
                                )
                                    if (
                                        (i[r].classList.add("open"),
                                        this._accordion)
                                    )
                                        for (
                                            var l = e._findChild(
                                ...
                                if (this._el) {
                                    ...
                                    this._el.classList.remove(
                                        ...
                                        this._wrapper &&
                                            ...
                                            (this._inner.style.marginLeft =
                                                null),
                                            (this._inner.style.marginRight =
                                                null)),
