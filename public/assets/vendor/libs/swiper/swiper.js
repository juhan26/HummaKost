        ...
        var G = {
                        ...
                        if ("auto" === s.slidesPerView) {
                            ...
                            if (
                                ...
                                if (o && "border-box" === o) L = e + n + l;
                                    ...
                                    const { clientWidth: t, offsetWidth: r } =
                                        i;
                                    L = e + s + a + n + l + (r - t);
                                }
                            }
            ...
            updateSlidesClasses: function () {
                const e = this,
                    ...
                    l = (e) =>
                        v(a, `.${s.slideClass}${e}, swiper-slide${e}`)[0];
                let o, d, c;
                if (
                    (t.forEach((e) => {
                        e.classList.remove(
            ...
            updateActiveIndex: function (e) {
                ...
                if (t.virtual && i.virtual.enabled && i.loop) u = c(d);
                    ...
                    const e = t.slides[d].getAttribute(
                ...
                slideToLoop: function (e, t, s, a) {
                    ...
                    if (i.params.loop)
                        if (i.virtual && i.params.virtual.enabled)
                            ...
                            const t = r
                                    ? Math.ceil(
                                          i.slides.length / i.params.grid.rows
                                      )
                                    : i.slides.length,
            ...
            X = {
                loopCreate: function (e) {
                    ...
                    if (!s.loop || (t.virtual && t.params.virtual.enabled))
                        return;
                    const i = () => {
                            v(a, `.${s.slideClass}, swiper-slide`).forEach(
                                (e, t) => {
                                    e.setAttribute(
                                        "data-swiper-slide-index",
                                        t
                      ...
                      a.currentTranslate > s.minTranslate() &&
                          ...
                          i.resistance &&
                              (a.currentTranslate =
                                  s.minTranslate() -
                                  1 +
                                  (-s.minTranslate() + a.startTranslate + g) **
                                      x)))
                    : g < 0 &&
                      (b &&
                          y &&
                      ...
                      a.currentTranslate < s.maxTranslate() &&
                          ...
                          i.resistance &&
                              (a.currentTranslate =
                                  s.maxTranslate() +
                                  1 -
                                  (s.maxTranslate() - a.startTranslate - g) **
                                      x))),
        ...
        const me = [
            function (e) {
                ...
                function c(e) {
                    ...
                    v(s.slidesEl, ".swiper-slide, swiper-slide").forEach(
                        (e) => {
                            e.style[g] =
                ...
                function d(e) {
                    ...
                    if (
                        ...
                        if (
                            ...
                            let e = !1;
                            if (
                                S(t.el, `.${t.params.slideClass}, swiper-slide`)
                                    .length > 0 &&
                                0 ===
                                    S(t.el, `.${t.params.slideActiveClass}`)
                                        .length
                            )
                                return;
                            const a = t.el,
            ...
            function (e) {
                ...
                function P() {
                    ...
                    if (
                        ...
                        i || (i = a.el);
                    else if (((i = n.querySelectorAll(a.el)), !i.length))
                        return;
                    t.params.uniqueNavElements &&
                        "string" == typeof a.el &&
                        i.length > 1 &&
                        ...
                        i &&
                            ...
                            r ||
                                ((r = b("div", t.params.scrollbar.dragClass)),
                                i.append(r))),
            ...
            function (e) {
                ...
                function b() {
                    ...
                    if (
                        ...
                        const e =
                            m.imageEl.naturalWidth / m.imageEl.offsetWidth;
                        return Math.min(e, s);
                    }
                    return s;
                }
                        ...
                        t.params.a11y.enabled &&
                            (() => {
                                ...
                                (p = C(p)),
                                    ...
                                    p &&
                                        p.forEach((t) =>
                                            g(t, r, e.nextSlideMessage)
                                        ),
                                    u &&
                                        u.forEach((t) =>
                                            g(t, r, e.prevSlideMessage)
                                        ),
                                    f() &&
                ...
                l("init", () => {
                    ...
                    (r.grid = {
                        ...
                        updateWrapperSize: (e, s) => {
                            const { centeredSlides: a, roundLengths: i } =
                                    r.params,
                                n = o(),
