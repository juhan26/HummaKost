    ...
    <section class="section-padding feedback-section">
        ...
        <div class="feedback-container container mt-10 overflow-y-auto h-96 px-4 border border-gray-300 rounded-lg sm:px-6 2xl:px-0"
            ...
            @forelse($feedbacks as $feedback)
                ...
                <div id="delete-feedback-modal-{{ $feedback->id }}" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="relative p-4 w-full max-w-md max-h-full">
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div
                                ...
                                <button data-modal-toggle="delete-feedback-modal-{{ $feedback->id }}" type="button"
                                ...
                                <form action="{{ route('feedback.destroy', $feedback->id) }}" method="POST"
                                    ...
                                    @csrf
                                    @method('DELETE')
                                    <button style="background: rgba(242, 4, 4, 0.875)" type="submit"
                                        class="text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 rounded-lg text-sm font-medium px-5 py-2.5 text-center dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-800">
                                        Delete
                                    </button>
                                </form>
                            </div>
            ...
            @empty
                <div class="flex items-center justify-center h-48">
                    <p class="text-center text-gray-500">Tidak Ada Komentar</p>
                </div>
            @endforelse
        </div>
