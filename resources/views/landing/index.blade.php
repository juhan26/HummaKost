                    ...
                    <div class="xl:w-1/2 w-full lg:px-[200px] md:px-[100px] xl:px-0">
                        <div class="flex flex-wrap gap-y-6 justify-between items-center md:mb-[62px] mb-6">
                            <div class="flex gap-6 items-center w-[239px] counter-card">
                                <div
                                    class="icon bg-primary-50 p-2.5 rounded-lg w-16 h-16 flex justify-center items-center">
                                    <svg viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M1.375 16.5L22 5.5L42.625 16.5L22 27.5L1.375 16.5Z" stroke="#1A906B"
                                            stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M32.3125 41.25V22L22 16.5" stroke="#1A906B" stroke-width="1.5"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                        <path
                                            d="M37.8125 19.061V28.4454C37.8113 28.7374 37.7147 29.0211 37.5375 29.2532C36.3859 30.8001 31.5047 36.4376 22 36.4376C12.4953 36.4376 7.61406 30.8001 6.4625 29.2532C6.28529 29.0211 6.18873 28.7374 6.1875 28.4454V19.061"
                                            stroke="#1A906B" stroke-width="1.5" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                    </svg>
                                </div>
                                <div>
                                    <h2 class="text-primary-900 xl:text-4xl md:text-2xl text-xl"><span
                                            class="counter">300</span></h2>
                                    <h4 class="text-gray-600 xl:text-xl md:text-base text-sm">Instructor</h4>
                                </div>
                            </div>
                            <div class="flex gap-6 items-center w-[239px] counter-card">
                                <div
                                    class="icon bg-secondary-50 p-2.5 rounded-lg w-16 h-16 flex justify-center items-center">
                                    <svg viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M4.125 10.3125H26.125C27.5837 10.3125 28.9826 10.892 30.0141 11.9234C31.0455 12.9549 31.625 14.3538 31.625 15.8125V32.3125C31.625 32.6772 31.4801 33.0269 31.2223 33.2848C30.9644 33.5426 30.6147 33.6875 30.25 33.6875H8.25C6.79131 33.6875 5.39236 33.108 4.36091 32.0766C3.32946 31.0451 2.75 29.6462 2.75 28.1875V11.6875C2.75 11.3228 2.89487 10.9731 3.15273 10.7152C3.41059 10.4574 3.76033 10.3125 4.125 10.3125V10.3125Z"
                                            stroke="#FFC27A" stroke-width="1.5" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path d="M31.625 19.25L41.25 13.75V30.25L31.625 24.75" stroke="#FFC27A"
                                            stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                </div>
                                <div>
                                    <h2 class="text-primary-900 xl:text-4xl md:text-2xl text-xl"><span
                                            class="counter">10000</span>+</h2>
                        ...
                        <div class="flex flex-wrap gap-y-6 justify-between items-center">
                            <div class="flex gap-6 items-center w-[239px] counter-card">
                                <div
                                    class="icon bg-pink-200 p-2.5 rounded-lg w-16 h-16 flex justify-center items-center">
                                    <svg width="44" height="44" viewBox="0 0 44 44" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M1.375 16.5L22 5.5L42.625 16.5L22 27.5L1.375 16.5Z" stroke="#ED4459"
                                            stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M32.3125 41.25V22L22 16.5" stroke="#ED4459" stroke-width="1.5"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                        <path
                                            d="M37.8125 19.061V28.4454C37.8113 28.7374 37.7147 29.0211 37.5375 29.2532C36.3859 30.8001 31.5047 36.4376 22 36.4376C12.4953 36.4376 7.61406 30.8001 6.4625 29.2532C6.28529 29.0211 6.18873 28.7374 6.1875 28.4454V19.061"
                                            stroke="#ED4459" stroke-width="1.5" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                    </svg>
                                </div>
                                <div>
                            ...
                            <div class="flex gap-6 items-center w-[239px] counter-card">
                                <div
                                    class="icon bg-blue-200 p-2.5 rounded-lg w-16 h-16 flex justify-center items-center">
                                    <svg width="44" height="44" viewBox="0 0 44 44" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M22 30.9375C25.797 30.9375 28.875 27.8595 28.875 24.0625C28.875 20.2655 25.797 17.1875 22 17.1875C18.203 17.1875 15.125 20.2655 15.125 24.0625C15.125 27.8595 18.203 30.9375 22 30.9375Z"
                                            stroke="#0075FD" stroke-width="1.5" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path
                                            d="M33.6875 19.9375C35.2889 19.9348 36.8688 20.3064 38.3012 21.0226C39.7336 21.7388 40.9788 22.7798 41.9375 24.0625"
                                            stroke="#0075FD" stroke-width="1.5" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path
                                            d="M2.0625 24.0625C3.02122 22.7798 4.26642 21.7388 5.69879 21.0226C7.13116 20.3064 8.71106 19.9348 10.3125 19.9375"
                                            stroke="#0075FD" stroke-width="1.5" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path
                                            d="M12.1 37.125C13.0055 35.2706 14.4136 33.7078 16.1639 32.6147C17.9142 31.5215 19.9364 30.9419 22 30.9419C24.0636 30.9419 26.0858 31.5215 27.8361 32.6147C29.5864 33.7078 30.9945 35.2706 31.9 37.125"
                                            stroke="#0075FD" stroke-width="1.5" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path
                                            d="M10.3125 19.9375C9.2686 19.9386 8.24596 19.6425 7.36406 19.084C6.48217 18.5254 5.77744 17.7274 5.33222 16.7832C4.88701 15.839 4.71969 14.7876 4.84982 13.7519C4.97995 12.7161 5.40216 11.7388 6.0671 10.9341C6.73205 10.1294 7.61228 9.5305 8.60494 9.20747C9.5976 8.88443 10.6617 8.85056 11.6729 9.10982C12.6841 9.36908 13.6006 9.91076 14.3154 10.6716C15.0301 11.4324 15.5136 12.3809 15.7094 13.4062"
                                            stroke="#0075FD" stroke-width="1.5" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path
                ...
                <div class="footer-widget min-w-[320px]">
                    <div class="footer-widget-title xl:mb-6 md:mb-4 mb-3">
                        <a href="#" class="cursor-pointer">
                            <img src="/assets/img/images/logo.png" alt="New Logo"
