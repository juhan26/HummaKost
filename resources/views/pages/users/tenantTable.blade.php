                                ...
                                <div class="col-10 col-lg-4 h-100 ms-auto">
                                    <div class="d-flex align-items-center w-100 px-3" id="divSearchInput"
                                        ...
                                        <input type="text" name="search" id="searchInput"
                                            class="form-control border-none" placeholder="Cari..."
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        @forelse ($users as $index => $user)
                                                ...
                                                <td>
                                                    ...
                                                    @else
                                                        @if ($user->status === 'pending')
                                                            <span
                                                                class="badge rounded-pill bg-label-warning me-1">Tertunda</span>
                                                        @elseif ($user->status === 'accepted')
                                                            <span
                                                                class="badge rounded-pill bg-label-primary me-1">Diterima</span>
                                                        @else
                                                            <span
                                                                class="badge rounded-pill bg-label-danger me-1">Ditolak</span>
                                                        @endif
                                                    @endif
                                                </td>
                                                @php
                                            ...
                                            <div class="modal fade" id="dismissModal{{ $user->id }}" tabindex="-1"
                                                aria-labelledby="dismissModalLabel{{ $user->id }}"
                                                aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title"
                                                                id="dismissModalLabel{{ $user->id }}">
                                                                Berhentikan <span
                                                                    class="text-primary">{{ $user->name }}</span>
                                                                </span>
                                                            </h5>
