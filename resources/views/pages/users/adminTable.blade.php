<div class="col-12 tab-pane fade" id="admin-tab-pane" role="tabpanel" aria-labelledby="admin-tab" tabindex="0">
    <div class="card">
            ...
            <div class="card-header">
                <div class="row align-items-center mt-4" style="height:fit-content">
                    <div class="col-12 col-lg-7 h-100 justify-content-center align-items-center mb-sm-5">
                        <h3 class="card-title">Ketua Kontrakan</h3>
                    </div>
                                ...
                                <div class="modal fade" id="deleteModal{{ $user->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p class="card-">Apakah anda yakin akan menghapus anggota ini?
                                                </p>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary"
            ...
            <div class="card-footer">
                @if ($users2->hasPages())
                    <div class="pagination-container ">
                        @php
                            $currentPage = $users2->currentPage();
                            $totalPages = $users2->lastPage();
                            $visiblePages = 1;

                            $totalData = \App\Models\User::count();
                            $dataPerPage = $users2->perPage();
                        ...
                        <ul class="pagination d-flex justify-content-between align-items-center">
                            ...
                            @else
                                <li class="page-item">
                                    <a class="page-link px-6 bg-primary text-white"
                                        href="{{ $users2->previousPageUrl() }}" rel="prev">Prev</a>
                                </li>
                            @endif
                            ...
                            <div class="d-sm-flex d-md-flex d-lg-none ">
                                <li class="page-item active" aria-disabled="true">
                                    <span class="page-link">{{ $users2->currentPage() }}</span>
                                </li>
                            </div>
                            ...
                            <div class="d-none d-lg-flex gx-4">
                                ...
                                @if ($currentPage > $visiblePages + 1)
                                    <li class="page-item">
                                        <a class="page-link" href="{{ $users2->url(1) }}">1</a>
                                    </li>
                                ...
                                @if ($currentPage < $totalPages - $visiblePages)
                                    ...
                                    <li class="page-item">
                                        <a class="page-link"
                                            href="{{ $users2->url($totalPages) }}">{{ $totalPages }}</a>
                                    </li>
                                @endif
                            </div>
                            ...
                            @if ($users2->hasMorePages())
                                <li class="page-item">
                                    <a class="page-link px-6 bg-primary text-white"
                                        href="{{ $users2->nextPageUrl() }}" rel="next">Next</a>
                                </li>
                            @else
                                <li class="page-item disabled" aria-disabled="true">
                                    <span class="page-link px-6 text-white"
